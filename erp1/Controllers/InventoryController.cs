...
namespace erp.Controllers
{
    ...
    public class InventoryController : ControllerBase
    {
        ...
        public ActionResult<List<Inventory>> GetInventories(string company, string sku)
        {
        ...
        public ActionResult UpdateInventory(string company, int warehouseId, string sku, int quantity)
        {
            IInventoryService inventoryService = m_platformServiceFactory.GetInventoryService(company);
            if (inventoryService != null)
            {
